"""
Django settings for phonemart project.
...
SECRET_KEY = 'django-insecure-$#wd27_xhbi1ubj)em&)^3seu4w#vv@69oc1@n(@l9%)%4#8kw'
...
# Optional: use this only if you have custom static files outside your apps
